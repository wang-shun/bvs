...
public class CssImage implements CssValue, ThemeResource {
	 ...
	 *
	 * @param path
	 *            the definition string to create the image from. Either
	 *            <code>none</code> or a path to an image
	 * @param loader
	 *            a resource loader which is able to load the image from the given
	 *            path
	 * @param gradientColors
	 *            an array with gradient colors
	 * @param gradientPercents
	 *            an array with gradient percents
	 * @param vertical
	 *            if true sweeps from top to bottom, else sweeps from left to right
	 */
	private CssImage(boolean none, String path, ResourceLoader loader, String[] gradientColors,
			float[] gradientPercents, boolean vertical) {
		this.none = none;
		this.path = path;
		this.loader = loader;
	...
	public boolean equals(Object object) {
		...
		if (object.getClass() == CssImage.class) {
			...
			return (path == null ? other.path == null : path.equals(other.path))
					...
					&& (gradientColors == null ? other.gradientColors == null
							: Arrays.equals(gradientColors, other.gradientColors))
					&& (gradientPercents == null ? other.gradientPercents == null
