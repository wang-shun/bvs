...
}) @XmlRootElement(name = "ViewProperties") public class ViewProperties
{
   ...
   }) public static class GridColumns
   {
      ...
      public List<ViewProperties.GridColumns.Column> getColumn()
      {
         if (column == null)
         {
            column = new ArrayList<ViewProperties.GridColumns.Column>();
         }
         return this.column;
      }
      ...
      }) public static class Column
      {
         ...
         @XmlElement(name = "Index", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter5.class) @XmlSchemaType(name = "int") protected Integer index;
         @XmlElement(name = "Width", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter5.class) @XmlSchemaType(name = "int") protected Integer width;
