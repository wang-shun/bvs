...
public class TreeEditor extends ControlEditor {
	...
	Runnable timer;
	// [if] Reduce TIMEOUT in order to execute the layout timer in the same request
	// (see bug 364802)
	...
	/**
	 * Returns the zero based index of the column of the cell being tracked by this
	 * editor.
	 *
	 * @return the zero based index of the column of the cell being tracked by this
	 *         editor
	 */
	...
	void resize() {
		layout();
		/*
		 * On some platforms, the table scrolls when an item that is partially visible
		 * at the bottom of the table is selected. Ensure that the correct row is edited
		 * by laying out one more time in a timerExec().
		 */
		if (tree != null) {
	...
	/**
	 * Specify the Control that is to be displayed and the cell in the tree that it
	 * is to be positioned above.
	 * <p>
