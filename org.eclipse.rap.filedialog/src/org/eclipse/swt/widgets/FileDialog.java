...
public class FileDialog extends Dialog {
	...
	/**
	 * Returns the file extensions which the dialog will use to filter the files it
	 * shows.
	 *
	...
	/**
	 * Sets initial client files to be uploaded. The upload of these files will
	 * start immediately after opening the dialog. Hence, this method must be called
	 * before opening the dialog.
	 * <p>
	 * A user can drag and drop files from the client operating system on any
	 * control with a drop listener attached. In this case, the client files can be
	 * obtained from the {@link ClientFileTransfer} object. This FileDialog can then
	 * be used to handle the upload and display upload progress.
	 * </p>
	 *
	 * @param files
	...
	/**
	 * Sets the maximum upload size in bytes. If upload size is bigger it will be
	 * interrupted. A value of -1 indicates no limit.
	 *
	 * @param limit
	...
	/**
	 * Returns the maximum upload size in bytes. The default value of -1 indicates
	 * no limit.
	 *
	 * @rwtextension This method is not available in SWT.
	 * @since 3.3
	...
	/**
	 * Sets the maximum upload duration in milliseconds. If upload takes longer it
	 * will be interrupted. The default value of -1 indicates no limit.
	 *
	 * @param limit
	 *            the maximum upload duration in milliseconds
	 *
	...
	/**
	 * Returns the maximum upload duration in milliseconds. The default value of -1
	 * indicates no limit.
	 *
	 * @rwtextension This method is not available in SWT.
	 * @since 3.3
	...
	/**
	 * Returns a list with exceptions thrown during the file upload. Will never
	 * return null.
	 *
	 * @see UploadSizeLimitExceededException
	 * @see UploadTimeLimitExceededException
	 ...
	 * <!-- Begin RAP specific -->
	 * <p>
	 * <strong>RAP Note:</strong> This method is not supported when running the
	 * application in JEE_COMPATIBILITY mode. Use
	 * <code>Dialog#open(DialogCallback)</code> instead.
	 * </p>
	 * <!-- End RAP specific -->
	 *
	...
	private UploadPanel createPlaceHolder(Composite parent) {
		String text = isMulti() ? RWTMessages.getMessage("RWT_FileDialogMultiUploadPanelMessage")
				: RWTMessages.getMessage("RWT_FileDialogSingleUploadPanelMessage");
		UploadPanel panel = new UploadPanel(parent, Arrays.asList(new String[] { text }));
	...
	private UploadPanel createUploadPanel(String[] fileNames) {
		...
		UploadPanel uploadPanel = new UploadPanel(parent, Arrays.asList(fileNames));
