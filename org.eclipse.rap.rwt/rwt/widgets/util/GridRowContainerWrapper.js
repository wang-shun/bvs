/*******************************************************************************
 * Copyright (c) 2011, 2017 Innoopract Informationssysteme GmbH and others. All
 ...
 * implementation EclipseSource - ongoing development
 ******************************************************************************/
...
rwt.widgets.util.GridRowContainerWrapper = function() {
	...
	////////////////////FIX RIGHT///////////////
	this._container[2] = new rwt.widgets.base.GridRowContainer();
	////////////////////FIX RIGHT///////////////
...
rwt.widgets.util.GridRowContainerWrapper.createInstance = function() {
	if (!this.prototype._protoInit) {
		...
		for (var i = 0; i < this._CONTAINER_GETTER_DELEGATES.length; i++) {
			this
					._createContainerGetterDelegater(this._CONTAINER_GETTER_DELEGATES[i]);
		}
...
rwt.widgets.util.GridRowContainerWrapper._createContainerDelegater = function(
		funcName) {
	this.prototype[funcName] = function() {
		...
		////////////////////FIX RIGHT///////////////
		this._container[2][funcName].apply(this._container[2], arguments);
		////////////////////FIX RIGHT///////////////

	};
};

rwt.widgets.util.GridRowContainerWrapper._createContainerGetterDelegater = function(
		funcName) {
	this.prototype[funcName] = function() {
		return this._container[0][funcName]
				.apply(this._container[0], arguments);
	};
};

rwt.widgets.util.GridRowContainerWrapper._CONTAINER_DELEGATES = [ "setParent",
		"destroy", "addEventListener", "removeEventListener",
		"setSelectionProvider", "setHeight", "setTop", "setBackgroundColor",
		"setBackgroundImage", "setRowHeight", "setTopItem", "renderItem",
		"setToolTip", "renderItemQueue", "setBaseAppearance",
		"setCellToolTipsEnabled", "getRow", "setToolTipText", "setDirection" ];

rwt.widgets.util.GridRowContainerWrapper._CONTAINER_GETTER_DELEGATES = [
		"getTop", "getHeight", "getHoverItem", "getElement",
		"getChildrenLength", "getRowCount" ];
...
rwt.widgets.util.GridRowContainerWrapper.prototype = {
	...
	setFixedRight : function(value){
		this._fixedRight = value;
		this._updateConfig();
	},
	...
	findItemByRow : function(row) {
		...
		////////////////////FIX RIGHT///////////////
		if (result == null) {
			result = this._container[2].findItemByRow(row);
		}
		////////////////////FIX RIGHT///////////////
	...
	findRowByElement : function(el) {
		...
		////////////////////FIX RIGHT ///////////////
		if (result == null) {
			result = this._container[2].findRowByElement(el);
		}
		////////////////////FIX RIGHT///////////////
		return result;
	},
	...
	updateGridLines : function() {
		...
		////////////////////FIX RIGHT///////////////
		this._container[2].getRenderConfig().linesVisible = this._config.linesVisible;
		this._container[2].getRenderConfig().variant = this._config.variant;
		this._container[2].updateGridLines();
		this._container[2].updateLeftBorder();
		////////////////////FIX RIGHT///////////////
	},
	...
	getRowIndex : function(row) {
		...
		////////////////////FIX RIGHT///////////////
		if (index < 0) {
			index = this._container[2].getRowIndex(row);
		}
		////////////////////FIX RIGHT///////////////
		return index;
	},
	...
	_updateConfig : function() {
		...
		////////////////////FIX RIGHT///////////////
		var configFix = this._container[2].getRenderConfig();
		this._copyConfigToSubContainer(configLeft, configFix);
		configFix.containerNumber = 2;
		configFix.hasCheckBoxes = false;
		////////////////////FIX RIGHT///////////////
		...
		for (var i = 0; i < cellOrder.length; i++) {
			...
			if(i==cellOrder.length-1){
				...
				configFix.itemLeft[column] = 0;
				configFix.itemImageLeft[column] = 0;
				configFix.itemTextLeft[column] = 0;
				configFix.markupEnabled = true;
				this.rightFixWidth = configFix.itemWidth[column];
			}else
			////////////////////FIX RIGHT///////////////
	...
	_layoutX : function() {
		...
		////////////////////FIX RIGHT///////////////
		var width = this._fixedRight?this._fixedRight:0;
		this._container[1].setWidth(this._width - leftWidth -width);
		this._container[2].setRight(0);
		this._container[2].setWidth(width );
		this._container[2].setRowWidth(width);
		////////////////////FIX RIGHT///////////////
