...
rwt.qx.Class.define( "rwt.widgets.Grid", {
  ...
  members : {
    ...
    _parseArgsMap : function( map ) {
      ...
      //ADD
      this._fixedRight = map.fixedRight;
      //ADD
    ...
    //Add---021519-
    setHideIndentionImage : function(value) {
    	this._config._hideIndentionImage = value;
    },
    
    setOverlayWidth : function(value) {
    	this._config._overlayWidth = value;
    },
