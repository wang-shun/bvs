...
rwt.remote.HandlerRegistry.add( "rwt.widgets.Grid", {
  ...
  factory : function( properties ) {
    ...
    var configMap = {
      ...
      //ADD
      hideIndentionImage : properties.hideIndentionImage,
      overlayWidth : properties.overlayWidth,
      fixedRight : properties.fixedRight,
      //ADD
  ...
  propertyHandler : rwt.remote.HandlerUtil.extendControlPropertyHandler( {
    ...
    //ADD
	"fixedRight" : function( widget, value ) {
	   rwt.widgets.util.GridUtil.setFixedRight( widget, value );
	},
    //ADD
