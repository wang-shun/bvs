...
rwt.qx.Class.define( "rwt.widgets.base.GridRow", {
  ...
  members : {
    ...
    _renderIndention : function() {
      ...
      if( this._item && this._gridConfig.treeColumn !== -1 ) {
    	    //Add---021519-
    	  if(!this._gridConfig._hideIndentionImage){
...
//    	    Add---021519-
    ...
    _renderCellLabelBounds : function( cell ) {
      ...
      if( element ) {
        ...
        //ADD
        if(this._gridConfig.containerNumber == 2){
        	var left = this._layout.cellLeft[ cell ];
        	element.css( {
        		"left" : this._mirror ? "" : left,
        		"right" : this._mirror ? left : "",
        	...
        	element.css( {
        		"left" : this._mirror ? "" : left,
        		"right" : this._mirror ? left : "",
        		"top" : this._layout.cellPadding[ 0 ],
        		"width" : this._layout.cellTextWidth[ cell ],
        		"height" : "auto"
        	} );
        }
      }
    ...
    _getOverlayElement : function() {
      if( this.$overlay === null ) {
        ...
        if(this._gridConfig._overlayWidth > 0){
        	this.$overlay.css( { "width" : ""+this._gridConfig._overlayWidth+"px", "height" : "100%"} );
        }else{
