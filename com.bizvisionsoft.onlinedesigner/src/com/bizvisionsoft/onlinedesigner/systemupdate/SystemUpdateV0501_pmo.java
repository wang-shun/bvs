...
public class SystemUpdateV0501_pmo {
	...
	public void execute() {
		try {
			...
			sb.append("本次更新内容：<br/>");
			sb.append("1. 重新创建数据库索引。<br/>");
			sb.append("2. 增加组织模板，在项目创建后，可直接通过套用组织模板的方式创建项目团队。<br/>");
			sb.append("3. 修改组织中项目承担单位字段名称为：qualifiedContractor。<br/>");
			sb.append("4. 增加报告管理，在其中可以查看我管理的项目的日报、周报和月报。<br/>");
			sb.append("5. 增加项目角色：项目管理组（角色编号为：PMO），功能角色：供应链经理、制造经理、财务经理，");
