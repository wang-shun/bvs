...
public class SidebarHeader {
	...
	public void createUI(Composite parent) {
		...
		parent.setHtmlAttribute("class", "gradient-red");
		...
		title.setText(
				"<div style='font-size:18px;font-weight:lighter;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:white;margin-left:2px;margin-top:12px;width:180px;'>系统管理</div>");
